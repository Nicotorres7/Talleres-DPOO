...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país de orígen de un atleta");
	...
	private void ejecutarBusquedaAtelta()
	{
		System.out.println("\n" + "Busqueda de un atleta y su país de orígen" + "\n");
		
		String atleta = input("Ingrese el nombre del atelta que desea consultar");
		Pais info = calculadora.consulta(atleta);
		System.out.println("El atelta " + atleta + " pertenece a " + info.darNombre());
